# investigation-guidance Specification

## Purpose
Defines how per-item investigation direction travels attached to a work item as structured `guidance`, distinct from the module's Benny-owned general analyst method and from raw event evidence. Guidance is a verified lead populated eagerly by the item producer, never fetched by the analyst.
