...
class VulnTriageReport(BaseModel):
    ...
    priority: str = Field(description="Remediation priority (e.g. critical/high/medium/low)")
    ...
    affected_assets: list[str] = Field(description="Assets affected by this vulnerability")
