...
class IncidentReport(BaseModel):
    alert_id: str = Field(description="ID of the alert that triggered this investigation")
    ...
    timeline: list[str] = Field(description="Ordered sequence of events found during investigation")
    investigation_steps: list[str] = Field(description="What the agent checked, in order")
