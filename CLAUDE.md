...
## Key Files
- `DESIGN.md` — Full architecture and requirements specification
- `TODO.md` — Open design questions to resolve
- `Skills/` — Agent skill definitions (YAML frontmatter + Markdown)
- `CONTEXT.md` — Agent system context/instructions
